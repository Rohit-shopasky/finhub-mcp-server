...
export function registerSearchTools(server, client) {
    ...
    server.registerTool("search_symbols", {
        ...
        description: "Search for stock ticker symbols by company name or keyword. Returns matching symbols with their exchange and type.",
        inputSchema: {
            query: z
                .string()
                .min(1)
                .describe("Search query — company name or partial ticker (e.g. 'Apple', 'TSLA', 'Microsoft')"),
            limit: z
                .number()
                .int()
                .min(1)
